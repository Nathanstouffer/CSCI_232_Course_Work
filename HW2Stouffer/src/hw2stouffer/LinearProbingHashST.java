...
public class LinearProbingHashST<Key, Value> {
    ...
    private void resize(int capacity) {
        ...
        for (int i = 0; i < m; i++) {
            if (vals[i] != null) {              // changed from keys[i] to vals[i] to elimante tombstone keys
    ...
    */
    ...
    /**
     * Creative programming problem Exercise 3.4.26
     * Written by Nathan Stouffer
     * @param key 
     */
    public void delete(Key key){
        if (key == null) throw new IllegalArgumentException("argument to delete() is null");
        ...
        vals[i] = null;         // set value of key to null
        n--;
