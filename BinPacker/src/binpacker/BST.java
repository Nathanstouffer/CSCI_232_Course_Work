...
public class BST<Key extends Comparable<Key>, Value> {
    ...
    /**
     * Returns the Node that has the smallest key larger than @param key
     * 
     * @param key
     * @return Node that has the smallest key larger than @param key
     */
    public Value bestFit(Key key){
